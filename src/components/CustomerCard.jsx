...
export function CustomerCard(){
    return(
        <tr>
            ...
            <td className="py-3 px-2 text-[#212529] text-base">adı@gmail.com</td>
            <td className="py-3 px-2 text-[#212529] text-base">
                90 44445555333
            </td>
            <td className="py-3 px-2 text-[#212529] text-base">
                Türkçe
           ...
           <td className="flex items-center gap-1 py-3 px-2">
                ...
                <div className="bg-[#f1f1f1] py-2 px-5 rounded-lg text-sm text-[#4b4b4b] font-semibold cursor-pointer hover:bg-[#c3c3c3] transition-colors duration-300 ease-in-out">
                    Hiç teklif yok
                </div>
           </td>
        </tr>
