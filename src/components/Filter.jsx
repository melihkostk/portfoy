    ...
    return (
        <div className="flex flex-col">
            <ul className='flex mt-10'>
                ...
                <li>
                    <button onClick={() => setType("Apartment")} className='px-7.5 py-2.5 text-sm opacity-70 cursor-pointer hover:opacity-100 transition-opacity duration-300 ease-in-out focus:opacity-100'>Apartman</button>
                </li>
                <li>
                    <button onClick={() => setType("Project")} className='px-7.5 py-2.5 text-sm opacity-70 cursor-pointer hover:opacity-100 transition-opacity duration-300 ease-in-out focus:opacity-100'>Proje Apartmanlar</button>
                </li>
                <li>
                    <button onClick={() => setType("Villa")} className='px-7.5 py-2.5 text-sm opacity-70 cursor-pointer hover:opacity-100 transition-opacity duration-300 ease-in-out focus:opacity-100'>Villa</button>
                </li>
                <li>
                    <button onClick={() => setType("Project Villa")} className='px-7.5 py-2.5 text-sm opacity-70 cursor-pointer hover:opacity-100 transition-opacity duration-300 ease-in-out focus:opacity-100'>Proje Villa</button>
                </li>
                <li>
                    <button onClick={() => setType("Land")} className='px-7.5 py-2.5 text-sm opacity-70 cursor-pointer hover:opacity-100 transition-opacity duration-300 ease-in-out focus:opacity-100'>Arsa</button>
                </li>
                <li>
                    <button onClick={() => setType("Field")} className='px-7.5 py-2.5 text-sm opacity-70 cursor-pointer hover:opacity-100 transition-opacity duration-300 ease-in-out focus:opacity-100'>Tarla</button>
                </li>
            </ul>
            {type === "All" && (
