...
export function LocationCard() {
    return (
        <div className="pb-5 mb-5 border-b border-b-[#eee] w-1/2">
            ...
            <div className="flex items-center gap-1">
                <button className="bg-[#f1f1f1] py-2 px-5 rounded-lg flex items-center gap-1 cursor-pointer text-sm text-[#4b4b4b] font-semibold hover:bg-[#c3c3c3] transition-colors duration-300 ease-in-out">
