        ...
        <div className='flex flex-col items-center font-sf'>
            ...
            <div className="w-full flex justify-center">
                <div className='w-full max-w-350'>
                    ...
                    <div>
                        <Questions question="Port-foy.com’a üye olabilmem için firma sahibi olmam gerekli mi?" />
                        <Questions question="Port-foy.com’a kimler üye olabilir?" />
                        <Questions question="Port-foy.com’dan hangi paketi almalıyım?" />
                        <Questions question="Port-foy.com’dan  üyelik aldıktan sonra kurlumu nasıl yapabilirim?" />
                        <Questions question="Port-Foy’ü sadece bilgisayarda mı kullanabilirim?" />
                        <Questions question="Port-foy.com’a yüklediğim ürünler kimler tarafından görüntülenebilir?" />
                        <Questions question="Platformdaki tüm bilgiler herkes tarafından görülecek mi?" />
                        <Questions question="Port-Foy’de mişterime sunum yapmak için müşterimi programa girmem gerekiyor mu?" />
                        <Questions question="Sadece kendi bölgemdeki gayrimenkullere mi erişimim var?" />
                        <Questions question="Port-foy.com’a eklediğimiz ürünleri potansiyel müşteriler görebilecek mi?" />
                    </div>
